...
}.call(this), window.SETTINGS = {}, SETTINGS.IS_PRODUCTION = !1, SETTINGS.APP_VERSION = "1.0.0", 
...
!function(window, $) {
    ...
    function initialize() {
        ...
        ES6Promise.polyfill(), Modernizr.touch && FastClick.attach(document.body), $("#audioElement").length && (Modernizr.touch || (SoundCloud = new App.SoundCloud($("#audioElement").get(0))));
    }
    var SoundCloud;
    $(initialize);
